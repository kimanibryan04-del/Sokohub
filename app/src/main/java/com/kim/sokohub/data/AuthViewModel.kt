package com.kim.sokohub.data

import android.content.Context
import android.widget.Toast
import androidx.navigation.NavController
import com.kim.sokohub.models.User
import com.kim.sokohub.navigation.ROUT_SERVICE
import com.kim.sokohub.navigation.ROUT_HOME
import com.kim.sokohub.navigation.ROUT_ONBOARDING
import com.kim.sokohub.navigation.ROUT_REGISTER


import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase
import com.kim.sokohub.navigation.ROUTE_ADD_PRODUCT
...
class AuthViewModel(var navController: NavController, var context: Context){
    ...
    fun signup(username:String, email:String, password:String, confirmpassword:String){
        ...
        if ( username.isBlank() || email.isBlank() || password.isBlank() || confirmpassword.isBlank()) {
            Toast.makeText(context,"Please username, email and password cannot be blank", Toast.LENGTH_LONG).show()
